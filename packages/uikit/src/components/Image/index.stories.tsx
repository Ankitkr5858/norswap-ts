...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `http://norswap.io/images/tokens/${token.address[81041]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `http://norswap.io/images/tokens/${token.address[81041]}.png`;
        const secondarySrc = `http://norswap.io/images/tokens/${tokens[randomTokenIndex].address[81041]}.png`;
