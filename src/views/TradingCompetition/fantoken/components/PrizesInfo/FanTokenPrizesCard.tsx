  ...
  return (
    <StyledCard>
      ...
      <Box p="24px">
        <Text color="textSubtle" fontSize="14px">
          {t(
            'Prizes to be distributed in NSWAP, LAZIO, PORTO and SANTOS in a distribution of 3:1:1:1 and shared by all members of each respective tier.',
          )}{' '}
          {t(
            'The price of token prizes (NSWAP, LAZIO, PORTO and SANTOS) in USD will be determined as per their NUSD pair price during the tally period.',
          )}
        </Text>
      </Box>
    </StyledCard>
