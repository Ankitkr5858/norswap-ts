// @ts-nocheck
// @ts-nocheck
import { Button, Flex, Box, Modal, Text, ChevronRightIcon, InjectedModalProps, Tag, Spinner } from '@nswap/uikit'
...
export const DetailLimitOrderModal: React.FC<DetailLimitOrderModalProps> = ({ onDismiss, order, formattedOrder }) => {
  ...
  const orderDetails = (
    <>
      ...
      <LimitTradeInfoCard
        currentPriceExchangeRateText="0.002474 NRK = 1 NUSD"
        currentPriceExchangeRateTextReversed="404.11169 NUSD = 1 NRK"
