...
import { Heading, Text, Button, ArrowForwardIcon, Link } from '@nswap/uikit'
  ...
  const steps: Step[] = [
    {
      ...
      canHover: true,
      text: t('Unstake LP tokens and NSWAP from the old MasterChef contract.'),
    },
    {
      stepId: ProgressStepsType.STEP2,
      canHover: true,
      text: t('Stake LP tokens and NSWAP to the new MasterChef v2 contract.'),
    },
  ]
  ...
  return (
    <div ref={tableWrapperEl}>
      <PageHeader>
        ...
        <Link href="https://docs.nordekscan.com/code/migration/migrate-your-stakings" external>
