...
import { Text, Button, useMatchBreakpointsContext } from '@nswap/uikit'
...
const MigrationSticky: React.FC<MigrationStickyProps> = ({ step, handleClick }) => {
  ...
  const title: string = isStep1 ? t('Unstaking LP Tokens and NSWAP') : t('Stake in the new contract.')
  const subTitle: string = isStep1
    ? t('All the earned NSWAP will be harvested to your wallet upon unstake.')
