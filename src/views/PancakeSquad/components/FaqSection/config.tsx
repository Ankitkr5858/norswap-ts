...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the NSWAP Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 NSWAP Bunny NFTs at the snapshot may also purchase one additional NSWAP Squad NFT in the presale for each NSWAP Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of NSWAP spent on NSWAP Squad NFTs will be burned as part of our weekly NSWAP burn.')],
  },
  {
