// @ts-nocheck
import { Flex, LinkExternal, Text } from '@nswap/uikit'
  ...
  return (
    <ModalInner mb="0">
      <Text as="p" mb="24px" fontSize="14px" color="textSubtle">
        {t(
          'Your voting power is determined by the amount of NSWAP you held at the block detailed below. NSWAP held in other places does not contribute to your voting power.',
        )}
      </Text>
