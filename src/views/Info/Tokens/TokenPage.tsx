        ...
        !tokenData.exists ? (
          ...
          <>
            ...
            <Flex justifyContent="space-between" mb="24px" flexDirection={['column', 'column', 'row']}>
              <Breadcrumbs mb="32px">
                <NextLinkFromReactRouter to="/info">
                  <Text color="#F4E17A">{t('Info')}</Text>
                </NextLinkFromReactRouter>
                <NextLinkFromReactRouter to="/info/tokens">
                  <Text color="#F4E17A">{t('Tokens')}</Text>
                </NextLinkFromReactRouter>
                <Flex>
              ...
              <Flex justifyContent={[null, null, 'flex-end']} mt={['8px', '8px', 0]}>
                <LinkExternal mr="8px" color="#F4E17A" href={getBscScanLink(address, 'address')}>
                  {t('View on Explorer')}
                </LinkExternal>
                {cmcLink && (
            ...
            <ContentLayout>
              <Card>
                <Box p="24px">
                  <Text bold small color="#F4E17A" fontSize="12px" textTransform="uppercase">
                    {t('Liquidity')}
                  </Text>
                  ...
                  <Text mt="24px" bold color="#F4E17A" fontSize="12px" textTransform="uppercase">
                    {t('Volume 24H')}
                  </Text>
