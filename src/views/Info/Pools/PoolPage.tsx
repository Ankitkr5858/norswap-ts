          ...
          <Flex justifyContent="space-between" mb="16px" flexDirection={['column', 'column', 'row']}>
            <Breadcrumbs mb="32px">
              <NextLinkFromReactRouter to="/info">
                <Text color="#009EE2">{t('Info')}</Text>
              </NextLinkFromReactRouter>
              <NextLinkFromReactRouter to="/info/pools">
                <Text color="#009EE2">{t('Pools')}</Text>
              </NextLinkFromReactRouter>
              <Flex>
                ...
                <Box p="24px">
                  <Flex justifyContent="space-between">
                    <Flex flex="1" flexDirection="column">
                      <Text color="#009EE2" bold fontSize="12px" textTransform="uppercase">
                        {t('Liquidity')}
                      </Text>
                  ...
                  <Text color="#009EE2" bold mt="24px" fontSize="12px" textTransform="uppercase">
