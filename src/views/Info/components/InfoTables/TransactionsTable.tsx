...
import { Text, Flex, Box, Radio, Skeleton, LinkExternal, ArrowForwardIcon, ArrowBackIcon } from '@nswap/uikit'
...
const TransactionTable: React.FC<{
  ...
  return (
    <Wrapper>
      ...
      <TableWrapper>
        <ResponsiveGrid>
          <Text color="#009EE2" fontSize="12px" bold textTransform="uppercase">
            {t('Action')}
          </Text>
        ...
        {transactions ? (
          <>
            ...
            <PageButtons>
              ...
              >
                <ArrowBackIcon color={page === 1 ? 'textDisabled' : '#009EE2'} />
              </Arrow>
              ...
              >
                <ArrowForwardIcon color={page === maxPage ? 'textDisabled' : '#009EE2'} />
              </Arrow>
            </PageButtons>
          </>
        ) : (
