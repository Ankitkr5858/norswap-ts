  ...
  return (
    <LightGreyCard>
      <Flex alignItems="center" justifyContent="space-between">
        <Text color="#ffffff" textTransform="uppercase" bold fontSize="12px">
          {t('Flexible')} APY:
        </Text>
        {flexibleApy ? (
          <AprLabelContainer alignItems="center" justifyContent="flex-start">
            <Balance fontSize="16px" color="white" value={parseFloat(flexibleApy)} decimals={2} unit="%" bold />
            <Button
              onClick={(e) => {
                e.stopPropagation()
              ...
              marginLeft="4px"
            >
              <CalculateIcon color="#ffffff" width="20px" />
            </Button>
          </AprLabelContainer>
        ) : (
        ...
        {lockedApy ? (
          <FlexGap gap="4px" flexWrap="wrap" justifyContent="flex-end">
            ...
            <AprLabelContainer alignItems="center">
              <Balance fontSize="16px" color="white" value={parseFloat(lockedApy)} decimals={2} unit="%" bold />
              <Button
                onClick={(e) => {
                  e.stopPropagation()
