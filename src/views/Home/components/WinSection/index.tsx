...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@nswap/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'NSWAP card' },
    { src: 'green', alt: 'Green NSWAP card with up arrow' },
    { src: 'red', alt: 'Red NSWAP card with down arrow' },
    { src: 'top-right', alt: 'NSWAP card' },
  ],
}
