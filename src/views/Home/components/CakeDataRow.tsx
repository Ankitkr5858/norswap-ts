 ...
 * https://planetfinanceio.medium.com/nswap-works-with-planet-to-help-cake-holders-f0d253b435af
 * https://twitter.com/nswap/status/1523913527626702849
  ...
  const {
    ...
    async () => {
      ...
      return {
        cakeSupply:
          totalSupply && burned
            ? +formatBigNumber(totalSupply.sub(totalBurned))
            : 0,
