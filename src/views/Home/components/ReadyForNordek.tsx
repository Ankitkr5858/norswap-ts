...
const WrapperSmall = styled(Flex)`
  z-index: 1;
  position: relative;
...
`;
const WrapperLarge = styled(Flex)`
  display: none;
  @media (min-width: 720px) {
    z-index: 1;
    position: relative;
  ...
  return (
    <>
      <WrapperSmall>
        ...
        {!account && <ConnectWalletButton scale="sm" mt="15px" />}
      </WrapperSmall>
      <WrapperLarge>
        <Flex>
          <svg
