      ...
      >
        <Flex flex="1" flexDirection="column">
          ...
          <Text color="#FFFFFF" fontSize="18px" mb="24px" mt="20px">
            {t('So investors using the NORDEK Swap platform just in your grasp get attractive benefits')}
          </Text>
        </Flex>
        <Flex
          ...
          position="relative"
        >
          <Image src={ImgBecomingAInvestor} priority placeholder="blur" alt={t('NSWAP')} />
        </Flex>
      </Flex>
    </>
  )
