...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and NSWAP pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and NSWAP pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from NSWAP pool', data)
  }
