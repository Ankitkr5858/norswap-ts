...
import { Image, Heading, RowType, Toggle, Text, Button, ArrowForwardIcon, Flex, Link } from '@nswap/uikit'
...
const Farms: React.FC = ({ children }) => {
  ...
  return (
    <FarmsContext.Provider value={{ chosenFarmsMemoized }} >
      <PageHeader background="#000000">
        <Heading as="h1" scale="xxl" color="#009EE2" mb="24px">
          {t('Farms')}
        </Heading>
        <Heading scale="lg" color="#ffffff">
      ...
      <Page style={{ backgroundColor: "#000000", maxWidth: "1400px", padding: "1px 100px" }} >
        <ControlContainer>
          <ViewControls>
            ...
            <ToggleWrapper>
              <Toggle
                ...
                scale="sm"
              />
              <Text color="#ffffff"> {t('Staked only')}</Text>
            </ToggleWrapper>
            <FarmTabButtons hasStakeInFinishedFarms={stakedInactiveFarms.length > 0} />
          </ViewControls>
          <FilterContainer>
            <LabelWrapper>
              <Text color="#ffffff" textTransform="uppercase">{t('Sort by')}</Text>
              <Select
                options={[
                  {
                    label: t('Hot'),
            ...
            <LabelWrapper style={{ marginLeft: 16 }}>
              <Text color="#ffffff" textTransform="uppercase">{t('Search')}</Text>
        ...
        <div ref={observerRef} />
        {/*<StyledImage src="/images/decorations/3dpan.png" alt="NSWAP illustration" width={120} height={103} />*/}
      </Page>
