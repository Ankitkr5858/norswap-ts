...
describe('maxAmountSpend', () => {
  ...
  it('should has value when CurrencyAmount is NRK and CurrencyAmount is higher than min nrk', () => {
    expect(
      JSBI.greaterThan(
  ...
  it('should be 0 when CurrencyAmount is NRK and CurrencyAmount is low', () => {
