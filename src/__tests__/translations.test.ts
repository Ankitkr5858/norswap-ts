...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master NSWAP chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of NSWAP.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's NSWAP)`,
...
describe('Check translations available', () => {
  ...
  throughDirectory('node_modules/@nswap/uikit', true)
