...
import { ConnectorNames, connectorLocalStorageKey, Text, Box, LinkExternal } from '@nswap/uikit'
            ...
            if (error instanceof NoEthereumProviderError || error instanceof NoBscProviderError) {
              toastError(
                ...
                <Box>
                  ...
                  <LinkExternal href="https://docs.nordekscan.com/get-started/connection-guide">
                    {t('Need help ?')}
                  </LinkExternal>
                </Box>,
              )
