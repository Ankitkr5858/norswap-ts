...
const CoreTag: React.FC<TagProps> = (props) => {
  ...
  return (
    <Tag variant="secondary" outline startIcon={<VerifiedIcon width="18px" color="#009EE2" mr="4px" />} {...props}>
      {t('Core')}
    </Tag>
  )
}
...
const FarmAuctionTagToolTipContent = memo(() => {
  const { t } = useTranslation()
  return <Text color="#000000">{t('Farm Auction Winner, add liquidity at your own risk.')}</Text>
})
