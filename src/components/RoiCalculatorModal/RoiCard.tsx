  ...
  return (
    <RoiCardWrapper>
      <RoiCardInner>
          ...
          {mode === CalculatorMode.PRINCIPAL_BASED_ON_ROI ? (
            ...
            <>
              <RoiDisplayContainer onClick={onEnterEditing}>
                ...
                <Text fontSize="24px" bold color="contrast">
                  $
                </Text>
                <RoiDollarAmount fontSize="24px" bold fadeOut={roiUSD > TRILLION} color="contrast">
                  {roiUSD.toLocaleString('en', {
                    minimumFractionDigits: roiUSD > MILLION ? 0 : 2,
                    maximumFractionDigits: roiUSD > MILLION ? 0 : 2,
                  })}
        ...
        <Text fontSize="12px" color="contrast">
          ~ {roiTokens} {earningTokenSymbol} (
          {roiPercentage < TRILLION ? roiPercentage.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : roiPercentage}
          %)
        </Text>
      </RoiCardInner>
    </RoiCardWrapper>
