...
export const DEFAULT_META: PageMeta = {
  title: 'NorSwap',
  description:
    'The most popular AMM on BSC by user count! Earn NSWAP through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by NSWAP), NFTs, and more, on a platform you can trust.',
  image: 'http://norswap.io/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for NSWAP exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for NSWAP exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for NSWAP exchanges.' },
      ...
      '/pancake-squad': { basePath: true, title: t('NSWAP Squad') },
    },
    defaultTitleSuffix: t('NSWAP'),
  }
}
