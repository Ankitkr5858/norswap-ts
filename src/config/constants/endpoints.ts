...
export const INFO_CLIENT = 'https://thegraph.norswap.io/subgraphs/name/nswap/exchange'
export const BLOCKS_CLIENT = 'https://thegraph.norswap.io/subgraphs/name/nswap/blocks'
export const GRAPH_API_NFTMARKET = process.env.NEXT_PUBLIC_GRAPH_API_NFT_MARKET
export const GRAPH_HEALTH = 'https://thegraph.norswap.io/index-node/graphql'
